...
public class GraphicOverlay extends View {
   ...
   * instances to the overlay using {@link dev.leonardom.detectposesmlandroid.utils.GraphicOverlay#add(Graphic)}.
   */
  public abstract static class Graphic {
    private dev.leonardom.detectposesmlandroid.utils.GraphicOverlay overlay;

    public Graphic(dev.leonardom.detectposesmlandroid.utils.GraphicOverlay overlay) {
